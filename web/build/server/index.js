import { H as HttpError, j as json, t as text, S as SvelteKitError, R as Redirect, e as error, A as ActionFailure, i as isRedirect } from './chunks/index-BkmUvga9.js';
import { w as with_request_store, b as base64_decode, r as root, d as decode_pathname, D as DEV, n as normalize_path, a as disable_search, c as decode_params, v as validate_layout_server_exports, e as validate_layout_exports, f as validate_page_server_exports, g as validate_page_exports, t as text_encoder, h as resolve, m as make_trackable, i as get_relative_path, j as base64_encode } from './chunks/root-BPP4VMgG.js';
import { D as DevalueError, i as is_primitive, g as get_type, a as is_plain_object, e as enumerable_symbols, s as stringify_key, b as stringify_string, v as valid_array_indices, u as uneval } from './chunks/renderer-D0X3o35U.js';
import { w as writable, r as readable } from './chunks/index-rPPP9l7g.js';
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Workend — developer workstation" />
    <title>Workend</title>
    <script>
      // Pick the theme before first paint to avoid a flash. Order of
      // precedence: explicit user choice (localStorage) > system preference.
      (function () {
        try {
          var stored = localStorage.getItem('workend_theme');
          var theme = stored;
          if (!theme) {
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-DI4cVHPX.js'));
  let reroute;
  let transport;
  return {
    handle,
