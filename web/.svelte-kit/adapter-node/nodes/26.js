import * as server from '../entries/pages/sandboxes/_page.server.ts.js';

export const index = 26;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/sandboxes/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/sandboxes/+page.server.ts";
