import * as server from '../entries/pages/projects/_id_/pipelines/_page.server.ts.js';

export const index = 19;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/projects/_id_/pipelines/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/projects/[id]/pipelines/+page.server.ts";
