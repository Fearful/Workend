...
export const actions = {
  createSecret: async ({ request, params, cookies }: import('./$types').RequestEvent) => {
  ...
  updateSecret: async ({ request, params, cookies }: import('./$types').RequestEvent) => {
    const data = await request.formData();
  ...
  deleteSecret: async ({ request, params, cookies }: import('./$types').RequestEvent) => {
    const data = await request.formData();
    const secretId = String(data.get('secret_id') || '');
